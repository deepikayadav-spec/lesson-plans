...
- **Three more empty `answer_explanation` fields here** — `c075b579`, `6973fab9`, `d2edf67e`. Authored and labelled. **Final total: 15 empty explanations across the first fifteen sessions.** That's a systematic gap, not a handful of oversights, and it's worth a content audit.
