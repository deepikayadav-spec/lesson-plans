...
- **Data note:** no source slide deck exists. Content sourced from extracted Concept Explanation/Introduction/Closure text. The original "Problem Solving" sub-page is image-only and unrecoverable — all worked/practice problems in this plan are **instructor-authored**, though the CAT=24 Hook and the A,C,E,G→I forward series directly match the source's own stated examples.
