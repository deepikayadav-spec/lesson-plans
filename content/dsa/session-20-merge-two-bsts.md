...
**Duration** 50 min <!-- placement: inferred — 50 min instead of the 45-min default because the two-stack dry run is the longest, most step-dense walkthrough in the entire BST topic (roughly 25 slides tracing individual pushes/pops), and needs real board time to land. --> · **Topic** Binary Search Tree · **Prerequisite** Predecessor and Successor in BST
